...
public class ReaderController {
    ...
    private ReaderInfo getReaderInfo(long readerId, String name, String sex, String birth, String address, String phone,String profile_picture) {
        ...
        readerInfo.setProfile_picture(profile_picture);
        return readerInfo;
    }
    ...
    public String readerInfoEditDo(HttpServletRequest request, String name, String sex, String birth, String address, String phone,String profile_picture, RedirectAttributes redirectAttributes) {
        long readerId = Long.parseLong(request.getParameter("readerId"));
        ReaderInfo readerInfo = getReaderInfo(readerId, name, sex, birth, address, phone,profile_picture);
    ...
    public String readerInfoAddDo(String name, String sex, String birth, String address, String phone, String password,String profile_picture, RedirectAttributes redirectAttributes) {
        ReaderInfo readerInfo = getReaderInfo(0, name, sex, birth, address, phone,profile_picture);
    ...
    public String readerInfoEditDoReader(HttpServletRequest request, String name, String sex, String birth, String address, String phone,String profile_picture, RedirectAttributes redirectAttributes) {
        ReaderCard readerCard = (ReaderCard) request.getSession().getAttribute("readercard");
        ReaderInfo readerInfo = getReaderInfo(readerCard.getReaderId(), name, sex, birth, address, phone,profile_picture);
        if (readerInfoService.editReaderInfo(readerInfo) && readerInfoService.editReaderCard(readerInfo)) {
